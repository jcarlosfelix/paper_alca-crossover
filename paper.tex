...
\section{Experiments}
    ...
    We describe the results shown in Figure~\ref{fig.experiment_F11-F15}, including functions F11 through F15.

    \begin{itemize}
        \item At function F11, only for the 10-dimensional category, the original OPx passed the statistical test compared to our proposed strategy CRx, while for the 30-dimensional type, they obtained similar results.
        \item At function F12, for both categories, 10 and 30 dimensions, the CRx strategy found better results than the OPx alternative, passing the statistical test in both cases.
