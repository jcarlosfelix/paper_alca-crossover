...
\section{Discussion}
    ...
    For each experiment, we ran fifty-one independent executions per CEC-2017 mathematical benchmark function and dimensions specified. We recorded the following results: best-found error average and standard deviation to calculate the statistical Z-Test value. The labels used on the results of our summarized results tables are the following:
