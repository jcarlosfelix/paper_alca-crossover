...
\section{Experiments}
    ...
    \begin{itemize}
        ...
        \item At function F5, only for the 10-dimensional category, the proposed strategy CRx passed the statistical test compared to its alternative OPx, while for the 30-dimensional type, they obtained similar results.
    \end{itemize}
